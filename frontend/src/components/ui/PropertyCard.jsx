...
export default function PropertyCard({ property, demoImg }) {
  const images = property.images?.length
    ? property.images.map(i => getImageUrl(typeof i === 'string' ? i : i.image_url))
    ...
    >
      ...
      <Link to={linkTo} className="pcard-media" aria-label={property.title}>
        ...
        {property.is_featured && (
          <span className="pcard-badge">Featured</span>
        )}
        ...
        {multiImage && (
          <div className={`pcard-arrows ${isHovered ? 'pcard-arrows--visible' : ''}`}>
            <button className="pcard-arrow pcard-arrow--prev" onClick={prev} aria-label="Previous image" type="button">
              <ChevronLeft size={20} />
            </button>
            <button className="pcard-arrow pcard-arrow--next" onClick={next} aria-label="Next image" type="button">
      ...
      <div className="pcard-body">
        ...
        <div className="pcard-footer">
          <div className="pcard-price">
            ...
            <span className="pcard-price-period"> / night</span>
          </div>
